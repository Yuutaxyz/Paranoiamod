...
public class PlantacuradeiraBlock extends ParanoiamodModElements.ModElement {
	@ObjectHolder("paranoiamod:plantacuradeira")
	public static final Block block = null;
	public PlantacuradeiraBlock(ParanoiamodModElements instance) {
		super(instance, 8);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("plantacuradeira");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PlantacuradeiraBlock.block, (int) (1)));
		}
