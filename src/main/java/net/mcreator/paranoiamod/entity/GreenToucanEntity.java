...
public class GreenToucanEntity extends ParanoiamodModElements.ModElement {
	public static EntityType entity = null;
	public GreenToucanEntity(ParanoiamodModElements instance) {
		super(instance, 24);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("green_toucan")
						.setRegistryName("green_toucan");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -10027162, -16777216, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("green_toucan"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.AMBIENT).add(new Biome.SpawnListEntry(entity, 5, 4, 4));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modeltucano(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("paranoiamod:textures/tucanoverdetextura.png");
				}
			};
		});
	}
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new FollowOwnerGoal(this, 2, (float) 10, (float) 2, false));
