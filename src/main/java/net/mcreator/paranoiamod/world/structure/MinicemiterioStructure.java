...
public class MinicemiterioStructure extends ParanoiamodModElements.ModElement {
	public MinicemiterioStructure(ParanoiamodModElements instance) {
		super(instance, 31);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 12000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("paranoiamod", "cemitery"));
						if (template == null)
							return false;
